...
$dashboardLink = '#';
if ($role === 'client') {
    $dashboardLink = '/homeplan/client/dashboard.php';
} elseif ($role === 'provider') {
    $dashboardLink = '/homeplan/provider/dashboard.php';
} elseif ($role === 'architect') {
    $dashboardLink = '/homeplan/architect/dashboard.php';
}
...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?= htmlspecialchars($dashboardLink) ?>" class="btn btn-outline-dark">Back</a>
    </div>
