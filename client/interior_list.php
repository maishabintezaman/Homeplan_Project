...
$res = mysqli_query($conn, "SELECT user_id, full_name, city, phone FROM users WHERE role='interior_designer' ORDER BY created_at DESC");
?>
<!doctype html><html><head><meta charset="utf-8"><title>Interior Designers</title>
